...
mod hap_lightbulb {
            ...
            + ControllerCmdSync<LeSetDataLength>,
    {
        ...
        .unwrap();
        hap_context
            .add_service(server.accessory_information.populate_support().unwrap())
            .unwrap();
        hap_context
            .add_service(server.protocol.populate_support().unwrap())
            .unwrap();
        hap_context
            .add_service(server.pairing.populate_support().unwrap())
            .unwrap();
        hap_context
